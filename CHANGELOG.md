...
* **transactions:** expõe data de competência e generaliza data de pagamento ([70815b8](https://github.com/Welington98/openmonetis/commit/70815b8ff74e725bfd88736502090efa072c7135))
...
* **bank-sync:** lista de conciliação mostra só o mês atual por padrão ([42960f4](https://github.com/Welington98/openmonetis/commit/42960f43df6890839a8796b87a658c7dc24d8bae))
...
* **transactions:** editar transferência com conta de origem e destino ([3bd0205](https://github.com/Welington98/openmonetis/commit/3bd020521a1c246e8d11023632c008175c7ffaa2))
...
* **loans:** desembolso e parcelas como transferências reais entre a conta de pagamento e a conta de empréstimo ([0873115](https://github.com/Welington98/openmonetis/commit/0873115dff2c45afd6e5e0b047b934af7e4c7107))
...
* **mcp:** adicionar tool create_transaction pro servidor MCP ([0973c9b](https://github.com/Welington98/openmonetis/commit/0973c9b02b4d41d4c55d1d3e64f70ebad8aed4b7))
...
* **transactions:** detalhar lançamento em itens (Detalhar/Desagrupar) ([2d298ab](https://github.com/Welington98/openmonetis/commit/2d298ab5d39f9ed191fb16648bff549a26485714))
...
* **accounts:** permite saldo negativo (Devedor) no ajuste de saldo ([2065de6](https://github.com/Welington98/openmonetis/commit/2065de6a1d8c2c20f6fc00a80eb360b0da267364))
...
* **transactions:** intervalo, parcela inicial e valor manual no parcelamento ([fe124e9](https://github.com/Welington98/openmonetis/commit/fe124e9cd45151ace28b0a9db720dee50f8788bc))
...
* **payables:** permite informar valor pago ao confirmar pagamento ([c6c65bb](https://github.com/Welington98/openmonetis/commit/c6c65bb6a04e8f626550b00b0f8d60b0ea96f31a))
...
* **bank-sync,import:** filtro de período na conciliação e import de fatura Sicredi em PDF ([c2439c9](https://github.com/Welington98/openmonetis/commit/c2439c92337dcb3522213c29936463d05ce04769))
...
* **daily-budget:** anchor daily quota on real money and fix pacing gaps ([25737f7](https://github.com/Welington98/openmonetis/commit/25737f7fef786e01e49bb484a75b388f9cdeb670))

## [2.17.1](https://github.com/Welington98/openmonetis/compare/v2.17.0...v2.17.1) (2026-09-06)

### Corrigido

* **drizzle:** repair broken migration history for fresh databases ([9fffcd0](https://github.com/Welington98/openmonetis/commit/9fffcd02446975ae545dab8049e6e527bf44909c))
...
* **bank-sync:** permite filtrar sincronização Pluggy por período ([2e4afbd](https://github.com/Welington98/openmonetis/commit/2e4afbddf12e4e5ecc470ca39c5bf0c9a91d9c6c))

## [2.14.0](https://github.com/Welington98/openmonetis/compare/v2.13.3...v2.14.0) (2026-09-04)

### Adicionado

* **mcp:** adiciona servidor MCP via HTTP para consulta de dados financeiros ([28d336a](https://github.com/Welington98/openmonetis/commit/28d336a871574cc5462c8fb30e9dc0388e66a08d))
...
* **backup:** usa pg_restore do container em modo docker ([d5bbcc1](https://github.com/Welington98/openmonetis/commit/d5bbcc1e36ca676ffc215ac909dbfdb752457b56))

## [2.11.0](https://github.com/Welington98/openmonetis/compare/v2.10.1...v2.11.0) (2026-09-01)

### Adicionado

* **payables:** adiciona aba de contas a pagar e a receber ([50bab0c](https://github.com/Welington98/openmonetis/commit/50bab0c72aa8048e3948854df3a70f9cc1100800))

	...
	},
	{
		...
		items: [
			...
			},
			{
				href: "/savings-goals",
				label: "Metas",
				description: "Acompanhe objetivos de acúmulo por conta",
				icon: <RiFlag2Line className="size-4" />,
				iconClass: "text-primary",
			},
			{
				href: "/bank-sync",
				label: "Sincronização bancária",
				description: "Conecte bancos via Open Finance e revise importações",
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				description: "Compare saldo do banco com o saldo local",

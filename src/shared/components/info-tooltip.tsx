...
/**
 * Botão de ícone "i" com tooltip explicando um card/coluna/conceito da
 * tela — título curto + lista de linhas. Usado em cards de métrica do
 * dashboard e nas páginas de orçamento diário/saldos.
 */
export function InfoTooltip({ label, helpTitle, helpLines }: InfoTooltipProps) {
	return (
		<Tooltip>
			<TooltipTrigger asChild>
				<button
					...
					aria-label={`Entenda ${label.toLowerCase()}`}
				>
